...
//	the adddress of the opaque object will be returned on success and NULL on
//	failure.
...
//	with the same value as the give c-string. The capacity of the string
...
//	copy of the address of the opaqure object will be returned on success and
//	NULL on failure.
